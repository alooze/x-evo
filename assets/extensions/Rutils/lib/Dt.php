<?php
namespace Modx\Ext\Rutils;

use Modx\Ext\Rutils\Struct\TimeParams;

/**
 * Russian dates without locales
 * Class Dt
 * @package Modx\Ext\Rutils
 */
class Dt
{
     ...
     * @param array|\Modx\Ext\Rutils\struct\TimeParams $params Params structure
